                ...
                <div className="accordion ml-6">
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-5xl font-semibold mb-6">What is an access token and refresh token? How do they work and where should we store them on the client-side ?</h1>
                        </div>
                        <div className="accordion-content">
                            <p className="text-2xl font-semibold mb-6">Access tokens and refresh tokens are both components of the token-based authentication process used in many web and mobile applications. They serve different purposes and work together to authenticate users and authorize access to protected resources.</p>
                            <h2 className="text-3xl font-semibold my-6" >1.Access Token:</h2>
                            <p className="text-2xl font-semibold mb-6">   - An access token is a credential used to access protected resources on behalf of the user. <br />
                            ...
                            <h2 className="text-3xl font-semibold my-6" >2. Refresh Token:</h2>
                            <p className="text-2xl font-semibold mb-6">   - A refresh token is a credential used to obtain a new access token once the original access token expires. <br />
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-5xl font-semibold mb-6">Compare SQL and NoSQL databases ?</h1>
                        </div>
                        <div className="accordion-content">
                            <p className="text-2xl font-semibold mb-6">SQL (Structured Query Language) and NoSQL (Not Only SQL) databases are two different types of database management systems, each with its own characteristics and use cases. Here's a comparison between the two:</p>
                            <h2 className="text-3xl font-semibold my-6" >1.Data Model:</h2>
                            <p className="text-2xl font-semibold mb-6">
                                <div className="my-4">
                            ...
                            <h2 className="text-3xl font-semibold my-6" >2.Schema:</h2>
                            <p className="text-2xl font-semibold mb-6">
                                <div className="my-4"> - SQL databases enforce a rigid schema, where the structure of the data (table columns, data types, relationships) is defined upfront. Any changes to the schema may require altering existing data.</div>
                                <div className="my-4">
                            ...
                            <h2 className="text-3xl font-semibold my-6" >3.Query Language:</h2>
                            <p className="text-2xl font-semibold mb-6">
                                <div className="my-4">- SQL databases use SQL (Structured Query Language) for querying and manipulating data. SQL is a powerful language for performing complex queries, joins, aggregations, and transactions.</div>
                                <div className="my-4"> - NoSQL databases may have their own query languages, APIs, or interfaces tailored to the specific data model they support. While some NoSQL databases support SQL-like query languages, others provide APIs for CRUD operations.</div>
                            </p>
                            <h2 className="text-3xl font-semibold my-6" >4.Scalability:</h2>
                            <p className="text-2xl font-semibold mb-6">
                                <div className="my-4"> - SQL databases are traditionally designed for vertical scalability, meaning they scale by adding more resources (CPU, RAM) to a single server. This approach may have limitations in handling large volumes of data and high concurrency.</div>
                                <div className="my-4">
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-5xl font-semibold mb-6">What is express js? What is Nest JS ?</h1>
                        </div>
                        <div className="accordion-content">
                            <p className="text-2xl font-semibold mb-6">
                                <div className="my-4">
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-5xl font-semibold mb-6">What is MongoDB aggregate and how does it work ?</h1>
                        </div>
                        <div className="accordion-content">
