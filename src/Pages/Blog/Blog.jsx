    ...
    return (
        <div className="flex items-center justify-center">
            <div className="container mx-auto py-8 px-4 md:px-6">
                <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-center mb-6">Blog</h1>
                <div className="accordion space-y-6">

                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-xl md:text-3xl lg:text-5xl font-semibold mb-4">What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1>
                        </div>
                        <div className="accordion-content space-y-4">
                            <p className="text-lg md:text-xl font-medium">Access tokens and refresh tokens are both components of the token-based authentication process used in many web and mobile applications. They serve different purposes and work together to authenticate users and authorize access to protected resources.</p>
                            <h2 className="text-lg md:text-2xl font-semibold">1. Access Token:</h2>
                            <p className="text-base md:text-lg">- An access token is a credential used to access protected resources on behalf of the user. <br />
                            ...
                            <h2 className="text-lg md:text-2xl font-semibold">2. Refresh Token:</h2>
                            <p className="text-base md:text-lg">- A refresh token is a credential used to obtain a new access token once the original access token expires. <br />
                            ...
                            <h2 className="text-lg md:text-2xl font-semibold">Where to Store on the Client-side:</h2>
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-xl md:text-3xl lg:text-5xl font-semibold mb-4">Compare SQL and NoSQL databases?</h1>
                        </div>
                        <div className="accordion-content space-y-4">
                            <p className="text-lg md:text-xl font-medium">SQL (Structured Query Language) and NoSQL (Not Only SQL) databases are two different types of database management systems, each with its own characteristics and use cases. Here's a comparison between the two:</p>
                            <h2 className="text-lg md:text-2xl font-semibold">1. Data Model:</h2>
                            <p className="text-base md:text-lg">
                            ...
                            <h2 className="text-lg md:text-2xl font-semibold">2. Schema:</h2>
                            <p className="text-base md:text-lg">
                            ...
                            <h2 className="text-lg md:text-2xl font-semibold">3. Query Language:</h2>
                            <p className="text-base md:text-lg">
                            ...
                            <h2 className="text-lg md:text-2xl font-semibold">4. Scalability:</h2>
                            <p className="text-base md:text-lg">
                    ...
                    <div className="accordion-item">
                        <div className="accordion-title">
                            <h1 className="text-xl md:text-3xl lg:text-5xl font-semibold mb-4">What is express js? What is Nest JS?</h1>
                        </div>
                        <div className="accordion-content space-y-4">
